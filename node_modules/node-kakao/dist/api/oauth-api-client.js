...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../config", "../request", "./header-util", "./web-client", "crypto"], factory);
    }
    ...
    class OAuthApiClient {
        ...
        createOAuthHeader(credential) {
            ...
            header['C'] = crypto_1.default.randomUUID();
            header['Adid'] = crypto_1.default.randomUUID();
            return header;
        }
        /**
