...
export class TalkClientSession implements ClientSession {
  ...
  async login(credential: OAuthCredential, sessionInfo: ChatSessionInfo): AsyncCommandResult<LoginResult> {
    ...
    const req: DefaultReq = {
      ...
      'chatIds': [],
      'maxIds': [],
      'lastTokenId': sessionInfo.lastTokenId,
      'lbk': sessionInfo.lastBlockId,
      'rp': null,
      'bg': false,
    ...
    return {
      ...
      result: {
        ...
        chatSessionInfo: { lastBlockId: lastRes.lbk, lastTokenId: lastRes.lastTokenId },
