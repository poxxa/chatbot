...
(function (factory) {
    if (typeof module === "object" && typeof module.exports === "object") {
        ...
        define(["require", "exports", "../../openlink", "../../request", "../../packet/struct", "./talk-open-link-session", "../channel", "bson", "crypto"], factory);
    }
    ...
    class TalkOpenChannelManageSession {
        ...
        async joinChannel(link, profile, passcode) {
            ...
            const reqData = {
                'li': link.linkId,
                'ref': `O001:[${JSON.stringify(ref)}]`,
                'adid': crypto_1.default.randomUUID(),
                ...openlink_1.OpenLinkProfile.serializeLinkProfile(profile),
            };
            if (token)
                reqData['tk'] = token;
        ...
        async chatOffChannel() {
            const res = await this._session.request('CHATOFF', {});
